...
const ConcluidoScreen = ({ navigation }: Props) => {
  ...
  useEffect(() => {
    async function listTarefas() {
      try {
        const response = await getTarefasByStaus(StatusTarefa.EM_ANDAMENTO);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonEmAndamento}>
        <Text style={styles.buttonEmAndamentoText}>Em Andamento</Text>
      </View>
